...
\input{chapters/energy_history.tex}
\input{chapters/energy_impact.tex}

\pagelayout{wide} % No margins
\addpart{Energies, a varied portfolio}
\pagelayout{margin} % Restore margins

\input{chapters/fossil_fuels.tex}
\input{chapters/renewables.tex}
\input{chapters/nuclear.tex}
\input{chapters/carbon_capture.tex}
\input{chapters/energy_storage.tex}
\input{chapters/grid.tex}
...
\input{chapters/greenhouse_effect.tex}
\input{chapters/co2_climate_models.tex}
\input{chapters/natural_hazards.tex}
...
\input{chapters/transition_scenarios.tex}
\input{chapters/carbon_footprints.tex}
\input{chapters/technology_costs.tex}
...
\input{chapters/transition_needs.tex}
\input{chapters/scenario_computation.tex}
%\input{chapters/renewable_problem.tex}
\input{chapters/scenario_assessment_s1s2.tex}
\input{chapters/scenario_assessment_s3s4.tex}
\input{chapters/transition_path.tex}

\pagelayout{wide} % No margins
\addpart{A path forward?}
\pagelayout{margin} % Restore margins

\input{chapters/world_needs.tex}
\input{chapters/not_all_doom.tex}
\input{chapters/mental_health.tex}

\pagelayout{wide} % No margins
\addpart{Life is Short, this Book is Long\ldots}
%\pagelayout{margin} % Restore margins

\input{chapters/takeaway.tex}
