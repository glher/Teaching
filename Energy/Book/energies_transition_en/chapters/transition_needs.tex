...
Of course, those scenarios are an exaggeration of what the near future may look like, but it will be interesting to compare their respective viability\sidenote[][-2mm]{Note that no scenarios involving fossil fuels for electricity generation are acceptable, as the end goal is to transition to low carbon energy sources. We will test the pertinence of this assumption.}.
