...
\item A gram of Uranium-235 is roughly equivalent to lifting 1.3 tons of water up 8 kilometers\sidenote[][-2mm]{Another way to look at it is taking 2 CESSNA-172 (around 1.3 tons each) up to cruising altitude (around 4km). Note that one gram is roughly a small paper clip.}
\end{itemize}
